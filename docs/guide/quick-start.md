---
title: 快速开始
description: NarrateFlow 5 分钟快速上手指南，从下载安装到生成第一个视频解说。
---
...
1. 访问 [Releases](https://github.com/Agions/NarrateFlow/releases/latest) 下载 `NarrateFlow-x.x.x-win.exe`
2. 双击运行，按提示完成安装
3. 从开始菜单启动 NarrateFlow

### macOS

1. 访问 [Releases](https://github.com/Agions/NarrateFlow/releases/latest) 下载 `NarrateFlow-x.x.x.dmg`
2. 打开 DMG，将 NarrateFlow 拖入应用程序
3. 首次运行右键点击 →「打开」→ 确认
...
即使不配置任何 API Key，NarrateFlow 仍可：
- 使用本地 FFmpeg 处理视频
- 使用 Edge-TTS 免费配音合成
- 手动编辑解说稿
...
启动 NarrateFlow 后，点击「新建项目」，输入项目名称。
